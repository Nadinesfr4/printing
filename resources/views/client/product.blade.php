                    ...
                    @foreach ($data as $item)
                        <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".3s">
                            <div class="feature_card">
                                <a class="item_image plus_effect" href="{{ route('product_detail', $item->id) }}">
                                    <img src={{ asset('assets/images/feature/img_02.jpg') }} alt="image_not_found">
                                </a>
                                <div class="item_content">
                                    <h3 class="item_title">{{ $item->nama_produk }}</h3>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="service_listlayout_boxed wow fadeInUp2 clearfix" data-wow-delay=".3s">
                            ...
                            <div class="item_content">
                                ...
                                <a class="text_btn" target="_blank" href="product_detail"><span>Read More</span> <i
                ...
                <div
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                        <div class="cta_content text-white">
                            ...
                            <a class="custom_btn bg_white wow fadeInUp2" data-wow-delay=".5s" target="_blank"
                                href="team.">
                                meet with us
